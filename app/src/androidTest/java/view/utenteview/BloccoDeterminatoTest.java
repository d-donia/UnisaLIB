...
public class BloccoDeterminatoTest {
    ...
    public void bloccoDeterminatoTest() throws InterruptedException {
        ...
        ViewInteraction textView = onView(
                allOf(withId(R.id.tvDataId), withText("Feb 25, 2022"),
                        withParent(withParent(IsInstanceOf.<View>instanceOf(android.widget.LinearLayout.class))),
                        isDisplayed()));
        textView.check(matches(withText("Feb 25, 2022")));

        ViewInteraction textView2 = onView(
                allOf(withId(R.id.tvOrarioId), withText("9 - 11"),
                        withParent(withParent(IsInstanceOf.<View>instanceOf(android.widget.LinearLayout.class))),
                        isDisplayed()));
        textView2.check(matches(withText("9 - 11")));
